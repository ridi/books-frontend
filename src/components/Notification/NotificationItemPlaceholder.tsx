...
const NotificationItemPlaceholder: React.FunctionComponent<NotificationItemPlaceholderProps> = ({ opacity }) => (
...
const NotificationPlaceholder: React.FunctionComponent<NotificationPlaceholderProps> = (props) => {
  const { num } = props;
